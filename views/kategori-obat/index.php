...
/* @var $searchModel app\models\search\KategoriObatSearch */
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Kategori Obats', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
