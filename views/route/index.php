        ...
        <div class="card-body">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <?=Html::a(Yii::t('rbac-admin', 'Add') . $animateIcon, ['create'], ['class' => 'btn btn-success', 'id' => 'btn-new']);?>
                </span>
            </div>
            <br>
            <div class="row">
                <div class="col-sm-5">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?=Html::a('<span class="fa fa-refresh"></span>', ['refresh'], ['class' => 'btn btn-default', 'id' => 'btn-refresh']);?>
                        </span>
                    </div>
