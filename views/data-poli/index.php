...
/* @var $searchModel app\models\search\DataPoliSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Polis';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="data-poli-index">
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Data Polis', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
