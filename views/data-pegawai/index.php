...
/* @var $searchModel app\models\search\DataPegawaiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Pegawais';
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Data Pegawais', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
