...
/* @var $searchModel app\models\search\LayananMedisSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Layanan Medis';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="layanan-medis-index">
            ...
            'toolbar' => [
                [
                    ...
                    Html::a(
                        ...
                        ['create'],
                        ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Layanan Medis', 'class' => 'btn btn-outline-primary']
                    ) .
                        Html::a(
