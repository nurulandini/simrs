...
/**
 * DataPegawaiSearch represents the model behind the search form about `app\models\DataPegawai`.
 */
class DataPegawaiSearch extends DataPegawai
{
    ...
    {
        return [
            [['id', 'nip', 'kelurahan_id', 'poli_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
